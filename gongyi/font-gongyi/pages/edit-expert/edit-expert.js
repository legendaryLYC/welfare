...
Page({
  ...
  edit: function () {
    ...
    wx.request({
      url: app.hostConfig.host + '/doctoredit/save',
      data: {
  ...
  loadPageData: function () {
    ...
    wx.request({
      url: app.hostConfig.host + '/doctoredit/edit',
      data: {
        id: that.data.hospitalId,
      },
      success: function (res) {
        console.log(res.data)
        that.setData({
          hospital: res.data['doctor'],
          name: res.data['doctor'].name,
          headimg: res.data['doctor'].headimg,
          detail: res.data['doctor'].detail,
        })
